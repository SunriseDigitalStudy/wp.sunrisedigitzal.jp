...
<body <?php body_class(); ?>>
	<div id="header">
		<div class="container">
			<h1><a href="http://wp.sunrisedigital.jp/"><img src="<?php bloginfo('template_directory');?>/images/logo.gif" alt="SiteNavi" /></a></h1>
			<p id="form">
			...
			<div id="navi-site" data-sync-receive="trigger-action">
				<ul>
